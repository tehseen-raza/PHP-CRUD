...
<body>
    ...
    <table>
        ...
        <a class="goBackBtn" href="http://localhost:8080/php-programs/crud/index.php">
            <span>
                <svg class="backSVG" data-v-61074ada="" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none" stroke="#2e3192" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right">
                    <line data-v-61074ada="" x1="5" y1="12" x2="19" y2="12"></line>
                    <polyline data-v-61074ada="" points="12 5 19 12 12 19"></polyline>
                </svg>
            </span> Go Back
        </a>
    </table>
